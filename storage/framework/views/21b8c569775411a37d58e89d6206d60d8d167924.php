			...
			<form method="POST" action="<?php echo e(url('save-cheque')); ?>">
				...
				<div class="box-body row">
					<div class="form-group col-md-6">
						...
						<input type="hidden" name="agent_id" value="<?php echo e($data['transaction']['agent_id']); ?>">
						<input type="hidden" name="agent" value="<?php echo e($data['transaction']['agent']); ?>">
