                ...
                <table class="table dataTable table-hover table-striped" id="transactions_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(url('view-transaction').'/'.$value['id']); ?>" class="btn btn-primary btn-sm"><span class="fa fa-eye"></span></a>
                                <?php if($value['is_issue'] == 0): ?>
                                <a href="<?php echo e(url('issue-cheque').'/'.$value['id']); ?>" class="btn btn-info btn-sm">Issue Cheque</a>
                                <?php else: ?>
                                <a href="<?php echo e(url('issue-voucher').'/'.$value['id']); ?>" class="btn btn-warning btn-sm">Issue Voucher</a>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ejn\ej\resources\views/admin/cheque/cheque-list.blade.php ENDPATH**/ ?>