        ...
        <div class="box box-success">
            ...
            <form method="POST" action="<?php echo e(url('submit-transaction')); ?>" id="transaction">
                ...
                <div class="box-body row">
                    ...
                    <input type="hidden" name="product_id" id="productID" value="<?php echo e($data['product_id']); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="number" name="gross_weight" value="<?php echo e(old('gross_weight')); ?>" class="form-control" placeholder="0.00" min="0" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="number" name="net_weight" value="<?php echo e(old('net_weight')); ?>" class="form-control" placeholder="0.00" min="0" required>
