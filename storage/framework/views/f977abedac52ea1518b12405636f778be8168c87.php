        ...
        <div class="box box-success">
            ...
            <form method="POST" action="<?php echo e(url('submit-transaction')); ?>" id="transaction">
                ...
                <div class="box-body row">
                    ...
                    <input id="productID" type="hidden" name="product_id" value="<?php echo e($data['product_id']); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-1">
                           <!--  <label for="" class="control-label mb-0">Gross Weight <span class="text-danger"> *</span></label>
                            <input type="number" id="gross_weight" name="gross_weight" value="<?php echo e(old('gross_weight')); ?>" class="form-control gross_weight" placeholder="0.00" min="0" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="number" id="net_weight" name="net_weight" value="<?php echo e(old('net_weight')); ?>" class="form-control net_weight" placeholder="0.00" min="0" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="text" name="moisture" value="<?php echo e(old('moisture')); ?>" class="form-control" class="form-control moisture" id="moisture">
...
$(document).ready(function() {
    ...
    $('.less').on('keyup', function() {
        ...
        less = parseInt(ntc)  + parseInt(others);
