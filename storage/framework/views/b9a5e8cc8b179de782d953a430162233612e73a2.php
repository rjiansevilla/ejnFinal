                ...
                <table class="table dataTable table-hover table-striped" id="transactions_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(url('view-transaction.coffee').'/'.$id); ?>" class="btn btn-primary btn-sm"><span class="fa fa-eye"></span></a>
                            </td>
                        </tr>
