                ...
                <div class="box-body row">
                    <div class="col-md-6">
                        <div class="form-group mb-1">
                            <label for="" class="control-label mb-0">Transaction No. <span class="text-danger"> *</span></label>
                            <select name="transaction_id" class="form-control select2">
                                ...
                                <option value="<?php echo e($value['id']); ?>"><?php echo e($value['transaction_no']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php if($errors->has('transaction_id')): ?>
                            <div class="error text-danger"><?php echo e($errors->first('transaction_id')); ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="form-group mb-1">
                            <label for="" class="control-label mb-0">Van No. <span class="text-danger"> *</span></label>
                            <input type="number" name="van_no" value="<?php echo e(old('van_no')); ?>" class="form-control" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ejnsys\resources\views/admin/shipment/shipment-transaction.blade.php ENDPATH**/ ?>