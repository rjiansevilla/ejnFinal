                ...
                <div class="box-body row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-1">
                            ...
                            <select name="quality" value="<?php echo e(old('quality')); ?>" class="form-control transaction-select2 w-100" required>
                        ...
                        <div class="form-group mb-1">
                            <label for="" class="control-label mb-0">Number of Sacks <span class="text-danger"> *</span></label>
                            <input type="number" name="sacks" value="<?php echo e(old('sacks')); ?>" id="sacks" class="form-control unit-price" placeholder="0" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <select name="station_id" value="<?php echo e(old('station')); ?>" class="form-control transaction-select2 w-100" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="number" name="gross_weight" value="<?php echo e(old('gross_weight')); ?>" class="form-control" placeholder="0.00" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <input type="number" name="net_weight" value="<?php echo e(old('net_weight')); ?>" class="form-control" placeholder="0.00" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-1">
                            ...
                            <input type="number" name="unit_price" value="<?php echo e(old('unit_price')); ?>" id="unit_price" class="form-control unit-price" placeholder="0.00" required>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <h4 class="font-weight-bold float-right d-inline" id="total_amount">0.00</h4>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ejn\ej\resources\views/admin/products/transaction-form.blade.php ENDPATH**/ ?>